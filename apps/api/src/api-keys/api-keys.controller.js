...
var ApiKeysController = (function () {
    function ApiKeysController(prisma) {
        this.prisma = prisma;
    }
    ApiKeysController.prototype.list = function (user) {
    ...
    ApiKeysController.prototype.create = function (user, dto) {
        return __awaiter(this, void 0, void 0, function () {
            var secret, keyHash, keyPrefix, record;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        secret = "ih_live_".concat((0, crypto_1.randomBytes)(32).toString('hex'));
                        keyHash = (0, crypto_1.createHash)('sha256').update(secret).digest('hex');
                        keyPrefix = secret.slice(0, 18);
                        return [4, this.prisma.apiKey.create({
                                data: {
    ...
    ApiKeysController.prototype.revoke = function (user, id) {
        return this.prisma.apiKey.updateMany({
            where: { id: id, organizationId: user.organizationId, revokedAt: null },
