...
var ProductsController = (function () {
    ...
    ProductsController.prototype.list = function (user, query) {
        return this.products.list(user.organizationId, query);
    };
    ProductsController.prototype.get = function (user, id) {
        return this.products.get(user.organizationId, id);
    };
    ProductsController.prototype.create = function (user, dto) {
        return this.products.create(user.organizationId, dto);
    };
    ProductsController.prototype.update = function (user, id, dto) {
        return this.products.update(user.organizationId, id, dto);
    };
    ProductsController.prototype.adjust = function (user, id, dto) {
        return this.products.adjustInventory(user.organizationId, id, dto);
    };
    ProductsController.prototype.remove = function (user, id) {
    ...
    __decorate([
        ...
        __metadata("design:paramtypes", [Object, dto_1.ListProductsDto]),
    ...
    __decorate([
        ...
        __param(2, (0, common_1.Body)()),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object, String, dto_1.AdjustInventoryDto]),
        __metadata("design:returntype", void 0)
