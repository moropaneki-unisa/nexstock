        ...
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            <div className="flex min-w-0 items-center gap-2">
              ...
              <span className="hidden shrink-0 items-center gap-1 rounded-full border bg-background/70 px-2 py-0.5 text-[0.68rem] font-medium text-muted-foreground sm:inline-flex">
                <Sparkles className="h-3 w-3" /> Workspace
              </span>
            </div>
            <p className="hidden truncate text-xs text-muted-foreground sm:block">{route.description}</p>
          </div>
        </div>
