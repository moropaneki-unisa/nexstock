  ...
  return (
    <div className="@container/main flex flex-1 flex-col gap-4 p-4 md:p-6">
      ...
      <div className="grid items-start gap-4 lg:grid-cols-2">
        <div className="grid gap-4 self-start lg:sticky lg:top-[calc(var(--header-height)+1rem)] lg:max-h-[calc(100vh-var(--header-height)-2rem)] lg:overflow-y-auto lg:pr-1">
