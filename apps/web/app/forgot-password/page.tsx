      ...
      <section className="mx-auto grid min-h-[calc(100vh-73px)] max-w-6xl items-center gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[1fr_28rem]">
        <div className="hidden lg:block">
          <p className="inline-flex items-center gap-2 border bg-card/95 px-3 py-2 text-xs font-semibold uppercase tracking-[0.22em] text-muted-foreground">
            <Mail className="h-3.5 w-3.5 text-primary" /> Account recovery
          </p>
          ...
          <section className="mt-8 border bg-card/95">
            <div className="divide-y">
              <InfoLine label="Secure reset link" />
              <InfoLine label="Expires after 30 minutes" />
              <InfoLine label="Existing sessions are cleared after reset" />
            </div>
          </section>
        </div>
        ...
        <div className="mx-auto w-full max-w-md lg:mx-0">
          <section className="border bg-card/95 shadow-sm">
            <div className="p-6 text-center lg:text-left">
              ...
              <p className="mt-5 text-xs font-semibold uppercase tracking-[0.22em] text-muted-foreground">Forgot password</p>
              <h2 className="mt-2 text-4xl font-black tracking-[-0.05em]">Reset your password</h2>
              <p className="mt-3 text-sm leading-6 text-muted-foreground">Enter your email address and we will send you a secure reset link.</p>
            </div>
            ...
            <div className="border-t bg-muted/20 px-5 py-4 text-center text-sm text-muted-foreground">
              Remembered your password? <Link href="/login" className="font-medium text-foreground hover:underline">Sign in</Link>
            </div>
          </section>
        </div>
      </section>
