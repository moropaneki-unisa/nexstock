...
export default function LandingPage() {
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="border-t bg-card/40 px-4 py-24 text-center sm:px-6 lg:px-10"><div className="mx-auto max-w-4xl"><h2 className="text-4xl font-black tracking-[-0.05em] md:text-6xl">Bring your product data under control.</h2><p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-muted-foreground">Create a NexStock workspace, configure your first source, map your fields, and start building cleaner product operations for your business.</p><div className="mt-8"><Link href="/signup" className="inline-flex items-center gap-2 rounded-full bg-primary px-8 py-4 text-sm font-bold text-primary-foreground shadow-sm transition hover:bg-primary/90">Create your workspace <Zap className="h-4 w-4" /></Link></div></div></section>
