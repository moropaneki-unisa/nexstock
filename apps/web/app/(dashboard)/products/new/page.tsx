...
import { ProductForm } from "@/components/products/product-form-organization-style";
  ...
  return (
    <PageShell className="space-y-6 pb-10">
      <PageHeader
        ...
        description="Create products using the same structured organization style: supplier cost first, then selling price, stock, media, and attributes."
        actions={
      ...
      <section className="border bg-card/95">
        <div className="flex flex-row items-start gap-4 p-5">
          <span className="flex h-10 w-10 shrink-0 items-center justify-center bg-primary/10 text-primary"><PackagePlus className="h-5 w-5" /></span>
          <div>
